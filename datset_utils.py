...
def merge_dataset(dataset,sensors_input):
    ...
    ## CALCULATE MEDIAIMESTAMP AND ADD NEW COLUMN FOR STATES
    ...
    ## CALCULATE MEDIAIMESTAMP AND ADD NEW COLUMN FOR SENSORS
    ...
    asdsss = []
    ## MATCHING OF STATES ON OBSERVATIONS FOR CLOSEST AVERAGES
